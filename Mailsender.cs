...
namespace MailSender
{
    ...
    {
        public void Yandex(string _To, string _cc, string _subject, string _content, string _email, string _pass)
        {
            try
            {
                var _defaultCredentials = false;
                var _enableSsl = true;
                using (var smtpClient = new System.Net.Mail.SmtpClient("smtp.yandex.com",587 ))
                {
        ...
        public void OEM(string _To, string _cc, string _subject, string _content, string _smtphost, int _smtpport, string _email, string _pass)
        {
            try
            {
                var _defaultCredentials = false;
